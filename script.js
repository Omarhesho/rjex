...
const products = [
  ...
  {id:11, category:'drinks', name:'The ice', description:'مزيج مثلج من آيس كريم التوت، كولا بطعم التوت، النعناع والثلج، لطعم فاكهي بارد ومنعش.', price:45, image:'asset/fakfakhito.jpeg'},
  {id:5, category:'drinks', name:'Iced Coffee', description:'قهوة مثلجة منعشة بطعم غني ومتوازن، تُقدم باردة مع لمسة كريمية لذيذة، مثالية لعشاق القهوة.', price:35, image:'asset/iced-coffee.jpeg'},
...
${p.image
  ...
  : `<div class="product-img empty-product-image" aria-label="${p.name}"></div>`
}          <div class="card-body">
            <h3>${p.name}</h3>
            <p>${p.description}</p>
