...
const products = [
  {id:1, category:'drinks', name:'موخيتو ليمون ونعناع', description:'ليمون منعش مع النعناع الطازج ولمسة غازية خفيفة، طعم منعش ومثالي لأي وقت.', price:25, image:'mojito-lemon-mint.jpeg'},
  {id:2, category:'drinks', name:'موخيتو توت', description:'مزيج منعش من التوت والليمون والنعناع، بطعم فاكهي لذيذ ولمسة منعشة.', price:30, image:'mojito-berry.jpeg'},
  {id:3, category:'drinks', name:'موخيتو فراولة', description:'فراولة حلوة ومنعشة مع الليمون والنعناع، تركيبة خفيفة بطعم فاكهي مميز.', price:30, image:'mojito-strawberry.jpeg'},
  {id:4, category:'drinks', name:'فخفخيتو', description:'مزيج مثلج من آيس كريم التوت، كولا بطعم التوت، النعناع والثلج، لطعم فاكهي بارد ومنعش.', price:40, image:'fakfakhito.jpeg'},
  ...
  {id:7, category:'noodles', name:'اندومي فراخ', description:'اندومي بنكهة الفراخ، بتتبيلة شهية وطعم غني ومميز.', price:20, image:'indomie-chicken.jpeg'},
  {id:8, category:'noodles', name:'اندومي لحمة', description:'اندومي بنكهة اللحمة، بتتبيلة لذيذة وطعم غني يناسب محبي النكهات القوية.', price:20, image:'indomie-meat.jpeg'},
  {id:9, category:'popcorn', name:'فشار بالملح', description:'فشار خفيف ومقرمش بنكهة الملح الكلاسيكية، سناك بسيط ولذيذ في أي وقت.', price:10, image:'popcorn-salt.jpeg'},
  {id:10, category:'popcorn', name:'فشار بالكراميل', description:'فشار مقرمش مغطى بطبقة كراميل حلوة، بطعم غني ومميز لعشاق النكهة الحلوة.', price:15, image:'popcorn-caramel.jpeg'}
];
